...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-4 text-center flex flex-col items-center">
		<div class="flex justify-center space-x-2 flex-col">
			<label class="label">
				<span>Username</span>
				<input class="input" type="text" name="username" value={data.patient?.username} disabled />
			</label>

			<label class="label">
				<span>Email</span>
				<input class="input" type="text" name="email" value={data?.patient?.email} disabled />
			</label>
			...
			<label class="label">
				...
				<input
					...
					type="tel"
					name="phone_number"
					value={data?.patient?.phone_number}
					disabled
				/>
			</label>
